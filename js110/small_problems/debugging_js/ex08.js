/* ANSWER: 
- the mistake is in the num.sort() statement
- the sort method doesn't have a callback function
- in the absence of a callback, the method will sort the array after converting all elements to strings
- it will take the UTF-16 values of the strings and use those to sort the array
- this will lead to a different outcome than sorting the array based on the actual numerical values
*/
