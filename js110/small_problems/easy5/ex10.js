...
function average(integersArray) {
  let countIntegers = integersArray.length;
  let arraySum = integersArray.reduce((accumulator, integer) => accumulator += integer, 0);

  return Math.floor(arraySum / countIntegers);
}
