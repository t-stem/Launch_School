...
// Test case
// console.log(sanitizeJoiner('   ,  ', 1, 1));
...
// Test case
// console.log(advancedJoin(['Apples', 'Pears', 'Apricots', 'Strawberries'], ' ; ', ' and '));
...
/* Test cases
let hand20 = [{type: 'Ace', value: 11}, {type: '7', value: 7}, {type: 'Jack', value: 10}, {type: 'Ace', value: 1}, {type: 'Ace', value: 11}, {type: '3', value: 3}, {type: 'Queen', value: 10}]
sortHand(hand20);
console.log(hand20)
*/
...
/* Test cases
let hand1 =[{type: '2', value: 2}, {type: '2', value: 2}, {type: 'Ace', value: null} , {type: '3', value: 3}];
console.log(calcHandValue(hand1)) // 18
console.log(hand1)
let hand2 =[{type: '3', value: 3}, {type: '2', value: 2}, {type: 'Ace', value: null} , {type: '5', value: 5}];
console.log(calcHandValue(hand2)) // 21
console.log(hand2)
let hand3 =[{type: '3', value: 3}, {type: '4', value: 4}, {type: 'Ace', value: null} , {type: '5', value: 5}];
console.log(calcHandValue(hand3)) // 13
console.log(hand3)
let hand4 =[{type: '2', value: 2}, {type: '3', value: 3}, {type: 'Ace', value: null} , {type: 'Ace', value: null}];
console.log(calcHandValue(hand4)) // 17
console.log(hand4)
let hand5 =[{type: '2', value: 2}, {type: '10', value: 10}, {type: 'Ace', value: null} , {type: 'Ace', value: null}];
console.log(calcHandValue(hand5)) // 14
console.log(hand5)
let hand6 =[{type: '2', value: 2}, {type: 'Ace', value: null}, {type: 'Ace', value: null} , {type: 'Ace', value: null}];
console.log(calcHandValue(hand6)) // 15
console.log(hand6)
let hand7 =[{type: '10', value: 10}, {type: 'Ace', value: null}, {type: 'Ace', value: null} , {type: 'Ace', value: null}];
console.log(calcHandValue(hand7)) // 13
console.log(hand7)
let hand8 =[{type: 'Ace', value: null}, {type: 'Ace', value: null}, {type: 'Ace', value: null} , {type: 'Ace', value: null}];
console.log(calcHandValue(hand8)) // 14
console.log(hand8)
let hand9 =[{type: '10', value: 10}, {type: '2', value: 2}, {type: 'Ace', value: null}, {type: 'Ace', value: null} , {type: 'Ace', value: null}];
console.log(calcHandValue(hand9)) // 15
console.log(hand9)
let hand10 =[{type: '2', value: 2}, {type: '2', value: 2}, {type: 'Ace', value: null}, {type: 'Ace', value: null} , {type: 'Ace', value: null}];
console.log(calcHandValue(hand10)) // 17
console.log(hand10)
*/
...
/* Test cases:
let deck = initializeDeck();
let hand = initializeHand(deck, CONTESTANTS['player']);
...
// Test case
// console.log(getValidInput(['yes', 'y', 'no', 'n']));
...
/* Test case
let hand11 =[{type: '2', value: 2}, {type: '2', value: 2}, {type: 'Ace', value: null}, {type: 'Ace', value: null} , {type: 'Ace', value: null}];
showHand(hand11);
*/
...
/* Test case:
let dealerHand = [{type: 'Ace', value: 10}, {type: 'Jack', value: 10}];
showDealerCard(dealerHand)
*/
...
function playerTurn (handOfPlayer, deckForTurn, handOfDealer) {
  ...
  console.clear();
  prompt(`You chose to stay at ${handOfPlayer['value']}.\n${LINE}`, COLORS[contestant]);
}

/* Test case:
let testDeck = initializeDeck();
let testHand = initializeHand(testDeck, CONTESTANTS['PLAYER']);
let dealerHand = [{type: 'Ace', value: 10}, {type: 'Jack', value: 10}];
console.log(playerTurn(testHand, testDeck, dealerHand));
*/
...
let testDeck = initializeDeck();
let testHand = initializeHand(testDeck, CONTESTANTS['player']);
console.log(dealerTurn(testHand, testDeck));
...
/* Test cases
let hand = [{type: '5', value: 5}, {type: '7', value: 7}, {type:'9', value: 9}];
hand['value'] = calcHandValue(hand);
hand['contestant'] = CONTESTANTS['player'];
console.log(determineOutcome(hand));
*/
